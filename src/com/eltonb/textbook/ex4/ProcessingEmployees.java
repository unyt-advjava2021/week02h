...
public class ProcessingEmployees
{
   public static void main(String[] args)
   {
      ...
      list.stream()
          .filter(e -> e.getSalary() >= 4000)  // filter(greaterThanOrEqualTo4K)
          .filter(e -> e.getSalary() <= 6000)  // filter(lessThanOrEqualTo6K)
          .sorted()
      ...
      groupedByDepartment.forEach(
         (String department, List<Employee> employeesInDepartment) -> 
         {
